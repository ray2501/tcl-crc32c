...
PKG_SOURCES	=  tclcrc32c.c
PKG_OBJECTS	=  tclcrc32c.o
...
PKG_LIB_FILE	= libcrc32c0.2.so
PKG_LIB_FILE8	= libcrc32c0.2.so
PKG_LIB_FILE9	= libtcl9crc32c0.2.so
PKG_STUB_LIB_FILE = libcrc32cstub0.2.a
...
top_builddir	= /home/danilo/Public/tcl-crc32c
